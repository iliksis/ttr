...
| `CLUB_NUMBER`      | —              | Club number to fetch teams/players for; club roster sync is skipped if unset |
| `CLUB_ORGANIZATION`| —              | Organization the club number belongs to (e.g. `WTTV`); club roster sync is skipped if unset |
